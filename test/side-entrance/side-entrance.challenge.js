...
describe("[Challenge] Side entrance", function () {
  ...
  it("Execution", async function () {
    ...
    const drainSideEntranceLenderPoolCF = await ethers.getContractFactory(
      "DrainSideEntranceLenderPool",
      player
    );
    const DrainSideEntranceLenderPool =
      await drainSideEntranceLenderPoolCF.deploy(this.pool.address);

    await DrainSideEntranceLenderPool.attack();
  });
